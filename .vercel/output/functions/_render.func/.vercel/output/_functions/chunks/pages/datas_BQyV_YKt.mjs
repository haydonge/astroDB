/* empty css                          */
import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as renderSlot, j as renderComponent, u as unescapeHTML, k as Fragment, l as renderHead } from '../astro_C_g3fONi.mjs';
import 'kleur/colors';
import { cva } from 'class-variance-authority';
import 'clsx';
import { twMerge } from 'tailwind-merge';
import { getIconData, iconToSVG } from '@iconify/utils';
import { i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_CtS3K-c3.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_CtS3K-c3.mjs'
    ).then(n => n.h).catch((e) => {
...
const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[]};
					const outDir = new URL("file:///D:/demo/astro-db-first-look/.vercel/output/static/");
...
const $$NumberInput = createComponent(async ($$result, $$props, $$slots) => {
...
const $$Dialog2Stock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Dialog2Stock;
  return renderTemplate`${maybeRenderHead()}<dialog id="dialog1"> <div class="p-4 sm:p-8 grid gap-6"> <form class="grid gap-4" id="add-form"> <h2 class="text-xl text-theme-accent font-bold leading-tight">
增加库存
...
const $$Datas = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="grid gap-6 grid-cols-[repeat(auto-fit,_minmax(280px,_1fr))] items-start"> ${Stocks.map((stock) => renderTemplate`${renderComponent($$result2, "StockCard", $$StockCard, { "stock": stock })}`)} </div>  ` })}`;
