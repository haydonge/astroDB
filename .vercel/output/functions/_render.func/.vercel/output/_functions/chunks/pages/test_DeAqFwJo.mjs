...
import 'kleur/colors';
import { a as $$Button, b as $$BaseLayout } from './datas_BNaZKPUe.mjs';
...
}, "D:/demo/astro-db-first-look/src/pages/test.astro", void 0);

const $$file = "D:/demo/astro-db-first-look/src/pages/test.astro";
const $$url = "/test";
